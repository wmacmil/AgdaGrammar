concrete FormulasAgda of Formulas = open Prelude in {
...
oper
  ...
  comprehensionH :  (x,y,z : Str) -> Str = \var,sort,prop ->
    -- fun3 "comprehension" a b c ;
    (fun2 (parenth (typingH var sort)) "*" prop) ;
  -- ExistCalledProp var sort ind prop =
  --   mkSE (fun2 (parenth (typingH var sort)) "*" prop.s) (ind.side ++ sep ++ ind.s ++ sep ++ prop.side) ; --- a kind of epsilon term; how to interpret
  ...
  defineH : (x,y : Str) -> Str = \a,b -> a ++ ": Set =" ++ b ;
